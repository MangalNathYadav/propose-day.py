a= input("You:")
if a == "Hi" or "hi" or "hello" or "Hello" or "hey"or "Hey":
    print("Your Love: Hii")
    b= input("You:")
    if b=="How are you" or "how are you":
        print("Your Love: fine \n Your Love: How are you")
        c= input("You:")
        print("Your Love: Hey i wanto say somehting to you" )
        d= input("You : ")
        print("Your Love: I love you so much \n Your Love: Happy propose day !! ")
        e= input("You: ")
    ...
    print("Phli fursat me niklo yah se ")
